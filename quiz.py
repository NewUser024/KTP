...
col_quiz_fiz = [[ sg.Text(data_fizik_questions ['1'])],
        [sg.Radio(data_fizik_answers ['1'], "RADIO1", key = 'INPUT1', default=False), sg.Radio('700',"RADIO1", default = False), sg.Radio('725', "RADIO1", default = False), sg.Radio('5', "RADIO1", default = False)],
        [sg.Text(data_fizik_questions ['2'])],
        [sg.Radio('(3;-5; 2)', "RADIO2", default = False), sg.Radio(data_fizik_answers['2'], "RADIO2", key = 'INPUT2', default=False), sg.Radio('(0;7;2)', "RADIO2", default = False), sg.Radio('(-2;-5;7)', "RADIO2", default = False)],
        [sg.Text(data_fizik_questions ['3'])],
        [sg.Radio('0', "RADIO3", default = False), sg.Radio('765', "RADIO3", default = False), sg.Radio('-7', "RADIO3", default = False), sg.Radio(data_fizik_answers ['3'], "RADIO3", key = 'INPUT3', default=False)],
        [sg.Text(data_fizik_questions ['4'])],
        [sg.Radio('45', "RADIO4", default = False), sg.Radio('0,4', "RADIO4", default = False), sg.Radio(data_fizik_answers['4'], "RADIO4", key = 'INPUT4', default=False), sg.Radio('0', "RADIO4", default = False)],
        [sg.Text(data_fizik_questions ['5'])],
        [sg.Radio('50см', "RADIO5", default = False), sg.Radio('0см', "RADIO5", default = False), sg.Radio(data_fizik_answers ['5'], "RADIO5", key = 'INPUT5', default=False), sg.Radio('66см', "RADIO5", default = False)],
        [sg.Text(data_fizik_questions ['6'])],
        [sg.Radio('100', "RADIO6", default = False), sg.Radio('120', "RADIO6", default = False), sg.Radio(data_fizik_answers['6'], "RADIO6", key = 'INPUT6', default=False), sg.Radio('-31', "RADIO6", default = False)],
        [sg.Text(data_fizik_questions ['7'])],
        [sg.Radio('(8;-2;0)', "RADIO7", default = False), sg.Radio(data_fizik_answers ['7'], "RADIO7", key = 'INPUT7', default=False), sg.Radio('-4;2;10', "RADIO7", default = False), sg.Radio('(0;0;0)', "RADIO7", default = False)],
        [sg.Text(data_fizik_questions ['8'])],
        [sg.Radio('230', "RADIO8", default = False), sg.Radio('0', "RADIO8", default = False), sg.Radio('400', "RADIO8", default = False), sg.Radio(data_fizik_answers['8'], "RADIO8", key = 'INPUT8', default=False)],
        [sg.Text(data_fizik_questions ['9'])],
        [sg.Radio(data_fizik_answers ['9'], "RADIO9", key = 'INPUT9', default=False), sg.Radio('(0;2)', "RADIO9", default = False), sg.Radio('-99;-4', "RADIO9", default = False), sg.Radio('2;∞', "RADIO9", default = False)],
        [sg.Text(data_fizik_questions ['10'])],
        [sg.Radio(data_fizik_answers['10'], "RADIO10", key = 'INPUT10', default=False), sg.Radio('240', "RADIO10", default = False), sg.Radio('7', "RADIO10", default = False), sg.Radio('150', "RADIO10", default = False)],
