...
col_quiz_fiz = [[ sg.Text(data_fizik_questions ['1'])],
        ...
        [sg.Radio('3a-5', "RADIO11", default = False), sg.Radio('a', "RADIO11", default = False), sg.Radio('-a', "RADIO11", default = False), sg.Radio(data_fizik_answers ['11'], "RADIO11", key = 'INPUT11', default=False)],
